...
api = Blueprint('api', __name__, url_prefix = '/api') # helps keep api calls categorized in the url, like putting them in a folder
# every time we write an api route, we need /api before the slug
